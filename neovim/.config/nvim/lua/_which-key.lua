...
register({
    ...
    ["."] = {"<cmd>Telescope find_files find_command=rg,-i,--hidden,--files,-g,!.git cwd=~/.dotfiles<CR>", "List Dotfiles"},
...
register({
  g = {
    ...
    ["?"] = {"<Plug>(GitGutterPreviewHunk)", "Hunk preview"},
    g = {":GitGutterToggle<cr>", "Hunk Toogle"},
